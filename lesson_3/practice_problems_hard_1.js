...
// second() will not reach the 'prop 1: "hi there"' piece of code as the engine will add a ; after the return statement,
...
// The last line will return "{ first: [1,2] }" as numArray is a reference to the original array and push() modified the
...
// Alyssa supplied Ben with a function named isAnIpNumber. It determines whether a string is a numeric string between 0 and 255 
